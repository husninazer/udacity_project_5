...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('awsomw star', starId1, {from: user1});
    await instance.createStar('awsomw star', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('awsomw star', starId, {from: userFrom});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo.call(starId, {from: user}), "Named star");
